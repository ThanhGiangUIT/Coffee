 ...
 * @author PTC
 */
public class AllProductsPage extends javax.swing.JFrame {

    /**
     * Creates new form AllProductsPage
     */
    int xx, xy;
    Dao dao = new Dao();
    ...
    private void tableProduct() {
        ...
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new AllProductsPage.ImageRenderer());
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (double i = 0.1; i <= 1.0; i += 0.1) {
            ...
            try {
                ...
                Logger.getLogger(AllProductsPage.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
